...
function LoginSelectPage() {
  ...
  return (
    <div>
        <h1 class="register">로그인</h1>
        <hr></hr>
        <br></br>
        <p className='homeReg'><a href='/members/new'>신규 회원가입</a></p>
        <br></br>
        <p><a href={KAKAO_AUTH_URL} >
          <span><img className="kakaoLoginBtn" src={kakao } width="183px" height="45px"></img></span></a></p>
